...
public class LoadBalancerTest {
    ...
    public void select() {
        ...
        requestParams.put("methodName", "1");
        System.out.println(requestParams.hashCode());
        // 服务列表
        ...
        System.out.println((serviceMetaInfo1.getServiceAddress() + "#" + 0).hashCode());
        ServiceMetaInfo serviceMetaInfo2 = new ServiceMetaInfo();
        serviceMetaInfo2.setServiceName("myService");
        serviceMetaInfo2.setServiceVersion("1.0");
        serviceMetaInfo2.setServiceHost("yupi.icu");
        serviceMetaInfo2.setServicePort(1120);
        System.out.println((serviceMetaInfo2.getServiceAddress() + "#" + 1).hashCode());
